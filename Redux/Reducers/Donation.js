...
const initialState = {
    ...
    items : [
    {
      ...
      description:
        'A lantern powered by solar energy, providing a sustainable and eco-friendly source of light to those in need.A lantern powered by solar energy.',
      image:
...
const Donation = createSlice({
    ...
    reducers :{
        ...
        updateSelectedDonationItemId : (state , action) => {
            ...
            state.selectedItemInformation = state.items.find((item) => item.donationItemId === action.payload);
        },
},
});

export const {updateSelectedDonationItemId , setToInitialState} = Donation.actions;
